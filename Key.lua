...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/n0namevnnek-web/Doors-Script/refs/heads/main/Doors", -- The raw URL of your main script
    ...
    HubDescription  = "Doors Script" -- The text shown below the title
}
